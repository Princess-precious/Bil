...
export default function EditStory() {
  ...
  // Supports both /edit-story/:storyId and /edit-story/:id
  const storyId = params.storyId ?? params.id;

  // Convert URL parameter from string to number
  ...
  const handleAIRequest = () => {
    ...
    setTimeout(() => {
      ...
      let response =
        "I'm your AI writing assistant. Once the AI backend is connected, I will be able to help you edit and improve your story.";
        ...
        <header className="mb-4 md:mb-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="border border-gray-300 px-4 py-2 text-sm text-gray-700 transition-colors hover:border-black hover:text-black"
            >
              Cancel
            </button>
          </div>
